...
class midvatten:
    ...
    def initGui(self):
        ...
        self.action_wlvlloggcalibrate = QAction(QIcon(":/plugins/midvatten/icons/calibr_level_logger_masl.png"), "Calibrar nível de agua pelo logger", self.iface.mainWindow())
